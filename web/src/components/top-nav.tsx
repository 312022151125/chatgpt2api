      ...
      <Dialog open={isCanvasDialogOpen} onOpenChange={setIsCanvasDialogOpen}>
        <DialogContent showCloseButton={false} className="rounded-2xl p-6">
          <DialogHeader className="gap-2">
            <DialogTitle>Open Third-Party App</DialogTitle>
            <DialogDescription className="text-sm leading-6">
              This entry is for personal testing only. We recommend deploying locally for long-term use. The redirect URL will include this project&apos;s address and current key by default to auto-fill connection details. If you prefer, cancel and open the app manually to enter them yourself.
            </DialogDescription>
          </DialogHeader>
