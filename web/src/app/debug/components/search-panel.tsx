...
export function SearchPanel() {
  const [prompt, setPrompt] = useState("Search for projects related to chatgpt2api");
  ...
  return (
    <section className={cn("mx-auto flex min-h-[calc(100vh-142px)] w-full max-w-6xl flex-col px-4 transition-all", searched ? "py-5" : "justify-center")}>
      <div className={cn("mx-auto w-full max-w-3xl", searched && "sticky top-3 z-10")}>
        {!searched ? (
          <p className="mb-5 text-center text-sm text-stone-500 dark:text-stone-400">Search the web using ChatGPT&apos;s advanced web search</p>
        ) : null}
        <form
