          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500">
                Configure an outbound proxy for requests to chatgpt.com; useful for servers in mainland China. Sub2API / CPA requests are not affected.
              </p>
            </div>
          </div>
        </div>
            ...
            <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-stone-200 bg-white px-4 py-3">
              ...
              <div className="space-y-0.5">
                ...
                <div className="text-sm text-stone-500">
                  When disabled, chatgpt.com requests will connect directly. Takes effect immediately after saving; no restart needed.
                </div>
              </div>
            </label>
