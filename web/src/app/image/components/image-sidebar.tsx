      ...
      <div className="flex h-full min-h-0 flex-col gap-2 py-1 sm:gap-3 sm:py-2">
        ...
        >
          {isLoadingHistory ? (
            ...
            <div className="px-2 py-3 text-sm leading-6 text-stone-500">No image history yet. Prompts will appear here.</div>
          ) : (
                  ...
                  >
                    ...
                    {stats.running > 0 || stats.queued > 0 ? (
                      <div className="mt-2 flex flex-wrap items-center gap-2 text-[11px]">
                        {stats.running > 0 ? (
                          <span className="rounded-full bg-blue-50 px-2 py-1 text-blue-600">Running {stats.running}</span>
                        ) : null}
                        {stats.queued > 0 ? (
